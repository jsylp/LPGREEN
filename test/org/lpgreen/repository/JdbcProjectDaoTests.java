...
public class JdbcProjectDaoTests  extends AbstractTransactionalDataSourceSpringContextTests  {
	...
	public void testFindAllSiteProjects() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByOwnerAccountId(2, null, false);
	...
	public void testFindProjectsByProjectCode() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByProjectCode(2, "Shanghai", null, false);
			assertNotNull(projects);
	...
	public void testFindProjectsByName() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByName(1, "New Bridge", null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 1);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
	...
	public void testFindProjectsByProjectManager1Id() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByProjectManager1Id(2, 4, currentPhases, false);
			assertNotNull(projects);
	...
	public void testFindProjectsByProjectManager2Id() {
		try {
			...
			Set<String> currentPhases = new HashSet<String>();
			currentPhases.add("Construction");
			List<Project> projects = projectDao.findProjectsByProjectManager2Id(2, 5, currentPhases, false);
			assertNotNull(projects);
	...
	public void testFindProjectsByCustomerAccountId() {
		try {
			// Test to find the projects by customer account id
			...
			Set<String> currentPhases = new HashSet<String>();
			currentPhases.add("Construction");
			List<Project> projects = projectDao.findProjectsByCustomerAccountId(2, 3, currentPhases, false);
			assertNotNull(projects);
	...
	public void testFindProjectsByCustomerContactId() {
		try {
			// Test to find the projects by customer contact id
			...
			Set<String> currentPhases = new HashSet<String>();
			currentPhases.add("Construction");
			List<Project> projects = projectDao.findProjectsByCustomerContactId(2,
	...
	public void testFindProjectsBySponsorId() {
		try {
			// Test to find the projects by sponsor id
			...
			Set<String> currentPhases = new HashSet<String>();
			currentPhases.add("Construction");
			List<Project> projects = projectDao.findProjectsBySponsorId(2,
	...
	public void testFindProjectsByManagingDeptId() {
		try {
			...
			Set<String> currentPhases = new HashSet<String>();
			currentPhases.add("Construction");
			List<Project> projects = projectDao.findProjectsByManagingDeptId(2, 5, currentPhases, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 2);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
	...
	public void testFindProjectsByStartDateRange() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByStartDateRange(2, startDate, endDate, null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 3);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
			...
			projects = projectDao.findProjectsByStartDateRange(2, startDate, endDate, null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 1);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
	...
	public void testFindProjectsByEndDateRange() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByEndDateRange(2, startDate, endDate, null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 2);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
			...
			projects = projectDao.findProjectsByEndDateRange(2, startDate, endDate, null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 2);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
	...
	public void testFindProjectsByParentProjectId() {
		try {
			...
			List<Project> projects = projectDao.findProjectsByParentProjectId(2, 4, null, false);
			assertNotNull(projects);
			assertTrue(projects.size() == 2);
			for (Project project : projects) {
				System.out.println("Project: id=" + project.getId() + "; code=" + project.getProjectCode() +
